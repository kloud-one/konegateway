package com.kone.gateway.config.timezone;

import com.kone.gateway.KonegatewayApp;
import com.kone.gateway.config.SecurityBeanOverrideConfiguration;
import com.kone.gateway.repository.timezone.DateTimeWrapper;
import com.kone.gateway.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, KonegatewayApp.class})
